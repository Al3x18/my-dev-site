  ...
  sections: [
    {
      ...
      content: [
        "Race Room provides Formula 1 results, standings, and weather information using third-party APIs, including **Jolpica API** for F1 data (calendar, standings, drivers, fastest laps, etc.), **OpenWeather API** for weather updates, and **GeoNames API** for geographical information.",
        "The app uses the RSS feed from **Motorsport.com** to display the latest Formula 1 news.",
        "**This app is not affiliated with, endorsed by, or associated with Formula 1, the FIA, or any related entities.**"
      ]
    },
    {
      title: "2. Use of Third-Party Services",
      content: [
        "The data displayed in this app is sourced from third-party services. We do not guarantee the accuracy, completeness, or availability of this data.",
        "Any service disruptions, incorrect data, or outages caused by third-party APIs or RSS feeds are beyond our control, and we are not responsible for any issues resulting from them."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "• Service disruptions, bugs, or technical failures.",
        "• Financial or personal losses related to app usage."
      ]
    },
    {
  ...
  sections: [
    {
      ...
      content: [
        "Race Room fornisce risultati di Formula 1, classifiche e informazioni meteorologiche utilizzando API di terze parti, tra cui **Jolpica API** per i dati sulla F1 (calendario, classifiche, piloti, giri veloci, ecc.), **OpenWeather API** per gli aggiornamenti meteo e **GeoNames API** per le informazioni geografiche.",
        "L'app utilizza il feed RSS di **Motorsport.com** per mostrare le ultime notizie sulla Formula 1.",
        "**Questa app non è affiliata, approvata o associata alla Formula 1, alla FIA o ad altre entità correlate.**"
      ]
    },
    {
      title: "2. Utilizzo di Servizi di Terze Parti",
      content: [
        "I dati mostrati in questa app provengono da servizi di terze parti. Non garantiamo l'accuratezza, completezza o disponibilità di questi dati.",
        "Eventuali interruzioni del servizio, dati errati o malfunzionamenti causati dalle API o dai feed RSS di terze parti sono al di fuori del nostro controllo, e non siamo responsabili di eventuali problemi derivanti da essi."
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        "• Interruzioni del servizio, bug o guasti tecnici.",
        "• Perdite finanziarie o personali legate all'uso dell'app."
      ]
    },
    {
