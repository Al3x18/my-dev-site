const knowledgeData = [
  ...
  },
  {
    ...
    category: 'university',
    topics: [
      'Introduction to Artificial Intelligence: foundations and applications',
      'Intelligent agents and operating environments',
      'Agent structure and architecture design',
      'Problem-solving agents and solution strategies',
      'Search algorithms: fundamental problem-solving techniques',
      'Uninformed search strategies: breadth-first, depth-first, uniform-cost search',
      'Informed search fundamentals: heuristic-guided exploration',
      'Heuristic functions in search problems: design and evaluation',
      'Local search and optimization problems',
      'Search with non-deterministic actions',
      'Search with partial observations',
      'Game theory: competitive and cooperative scenarios',
      'Alpha-beta heuristic search: game tree pruning and optimization',
      'Constraint satisfaction problems (CSP): modeling and solving',
      'Backtracking search for CSP: systematic constraint resolution',
      'Local search in constraint satisfaction: iterative improvement methods',
      'Knowledge-based agents: reasoning with information',
      'Logic and propositional logic: formal representation',
      'First-order logic: predicates, quantifiers, and expressiveness',
      'Using first-order logic: knowledge representation and reasoning',
      'Introduction to inference: logical deduction methods',
      'Inference in first-order logic: resolution and unification',
      'Forward and backward chaining: rule-based reasoning',
      'Resolution and equality: theorem proving techniques',
      'Knowledge representation: structured information encoding',
      'Physical composition and measurement: sensor integration',
      'Automatic planning: action sequences and goal achievement',
      'Quantifying uncertainty: probabilistic reasoning foundations',
      'Basic probability theory notation: events, distributions, and independence',
      'Knowledge representation in uncertain domains',
      'Bayesian network construction: probabilistic graphical models',
      'Combining beliefs and desires under uncertainty: decision-making frameworks',
      'Utility functions: preference modeling and optimization',
      'Decision networks: structured decision analysis',
      'Sequential decision problems: multi-step planning under uncertainty',
      'Optimal policies and state utilities: value iteration and policy iteration',
      'Multi-agent decisions: cooperative and competitive scenarios',
      'Multi-agent planning: coordination and negotiation strategies',
      'Decision tree learning: classification and regression trees',
      'Univariate linear regression: predictive modeling fundamentals',
      'Linear classifiers: perceptron and support vector machines',
      'Deep Learning foundations and structure: neural network architecture',
      'Convolutional Neural Networks (CNN): image processing and feature extraction',
      'Generalization in Deep Learning: overfitting prevention and regularization'
    ]
  }
]
